    ...
    <div class="container-fluid">
        <div class="row justify-content-center">
            ...
            <div class="col-lg-6 col-md-7 col-sm-12 align-left card" data-form-type="formoid">
                ...
                <form class="mbr-form" action="create-post-post.php" method="post" data-form-title="Mobirise Form" enctype="multipart/form-data">
                    ...
                    <?php
                        ...
                        while($row = $result->fetch_assoc()){
                            echo "<option value='".$row['id']."'>".$row['make_name']."</option>";
                        }
                    ?>
								</select>
                            </div>
