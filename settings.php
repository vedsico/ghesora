    ...
    <div class="container-fluid">
        <div class="row justify-content-center">
            ...
            <div class="col-lg-6 col-md-7 col-sm-12 align-left card" data-form-type="formoid">
                ...
                <form class="mbr-form" action="settings-post.php" method="post" data-form-title="Mobirise Form" enctype="multipart/form-data">
...
<div class="col-md-12 multi-horizontal" data-for="email">
                            <div class="form-group">
                                <h4 class="mbr-fonts-style pb-2 mbr-bold form-title display-4"><span style="font-weight: normal;">
                                        Introduce e-mailul</span></h4>
                                <input value="<?php echo $user["email"]; ?>" placeholder="Introduce e-mailul" type="text" name="name" class="form-control" data-form-field="email" required="" id="name-form1-z">
                            </div>
                        </div>
                    </div>
